...
def main():
    ...
    if escolha == "Filtros":
        ...
        st.markdown("Para ver mais projetos, acesse meu [GitHub](https://github.com/rafaelnduarte).")
        st.text("Rafael Duarte - Cientista de Dados no Sigmoidal.ai")
        st.success("Instagram @rafaelnduarte")
        rafael = Image.open("Rafael-1.jpg")
        st.image(rafael, width=500)
